...
export default function EpisodesView({ apiFetch, showToast, showConfirm, categories, subcategories, specializedFields, loadGlobalLists }) {
  ...
  const handleEditClick = (ep) => {
    ...
    setFormData(ep ? {
      ...
      mentor_email: ep.mentor_email || '',
      mentor_timezone: ep.mentor_timezone || 'America/New_York'
    } : {
      ...
      is_mentor: false, mentor_rate: '', mentor_avail: '', mentor_linkedin: '', mentor_fields: '', mentor_meet_link: '', mentor_email: '', mentor_timezone: 'America/New_York', status: 'published',
                  ...
                  <div className="animate-fade" style={{ display: 'flex', flexDirection: 'column', gap: '16px', background: 'hsl(var(--bg-dark))', padding: '16px', borderRadius: 'var(--border-radius-md)', border: '1px solid hsl(var(--border-color))' }}>
                    ...
                    <div className="grid-cols-2">
                     ...
                     <div className="form-group">
                       ...
                       <input 
                         type="email" className="input-field" name="mentor_email" placeholder="e.g. mentor@bnbgirl.com"
                         value={formData.mentor_email || ''} onChange={handleTextChange} 
                       />
                     </div>
                     <div className="form-group">
                    ...
                    <div className="form-group">
                     ...
                     <div className="form-group">
                        <label>Mentor Timezone (Auto-detected / Read-only)</label>
                        <input type="text" className="input-field" name="mentor_timezone" value={formData.mentor_timezone || 'America/New_York'} readOnly style={{ background: 'var(--bg-light)', cursor: 'not-allowed', opacity: 0.8 }} />
                      </div>
                    <div className="form-group">
